            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="area-heading">
                        ...
                        <p> Online Insurance System is a web system which is used to tracking details on insurance policies, customer details and company details. The company tries to give insurance policy holders quick access to their insurance policy details, modify or update the datails and even renew an expired insurance policy. All this, with a single click on your computer, at the comfort of your home.</p>
                    </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="single-about">
                                ...
                                <div class="single-about-content">
                                    <h5>Easy Access</h5>
                                    <p> Online Insurance System provides easy access and ease of use to our clients which makes our system reliable.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
