        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="adminhome.php">Online Insurance </a>
                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="ims/account_details.php">User Account</a></li>
                                    <li class="nav-item"><a class="nav-link" href="ims/comment_details.php">Comment Details</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
