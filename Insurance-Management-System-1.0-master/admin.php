            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  <h2 style="color: #191970; font-weight: bold">Admin Insurance MIS</h2>
                  <p class="mb-4" style="color: #fff; font-weight: bold">Admin Insurance company is a web application which is used to tracking the details about the insurance policy, customer details and company details. The company tries to give insurance policy holders quick access to their insurance policy details, modify or update the datails and even renew an expired insurance policy. All this, with a single click on your computer, at the comfort of your home.
                ...
                <div class="col-lg-5 ml-auto">
                  <form action="admin.php" method="post" class="form-box">
                    ...
                    <div class="form-group">
                      <input type="submit" name="admlogin" class="btn btn-primary btn-pill" value="Login" style="margin-right: 20px">
