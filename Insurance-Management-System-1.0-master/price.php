            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single-pricing">
                        ...
                        <div class="single-pricing-content">
                            <h5>Standard</h5>
                            <h4>5.000.000đ<span class="currency_line">/</span><span>month</span></h4>
                            <ul>
                              <li>Single Policy Insurance</li>
                                <li>12% Discount</li>
                                <li>12hr Support</li>
                            </ul>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single-pricing">
                        ...
                        <div class="single-pricing-content">
                            <h5>Business</h5>
                            <h4>10.000.000đ<span class="currency_line">/</span><span>monthly</span></h4>
                            <ul>
                                <li>Single Policy Insurance</li>
                                <li>25% Discount</li>
                                <li>12hr Support</li>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single-pricing">
                        ...
                        <div class="single-pricing-content">
                            <h5>Premium</h5>
                            <h4>15.000.000đ<span class="currency_line">/</span><span>Yearly</span></h4>
                            <ul>
                                <li>Double policy Insurance</li> 
                                <li>10% Discount</li>
                                <li>24/7 Support</li>
                            </ul>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single-pricing">
                        ...
                        <div class="single-pricing-content">
                            <h5>Ultimate</h5>
                            <h4>20.000.000đ<span class="currency_line">/</span><span>yearly</span></h4>
                            <ul>
                                <li>Triple insurance policies</li>
                                <li>20% Discount</li>
                                <li>24/7 Support</li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="area-heading">
                        ...
                        <p>Do you have a question about our services <br>Here are some Frequently asked questions</p>
                    </div>
                </div>
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <h5 class="mb-0">
                                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        Who do I contact for policy related inquiries?
                                    </button>
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body">
                                    Use the numbers provided below. Or you can ultimately live a comment.
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-header" id="headingTwo">
                                <h5 class="mb-0">
                                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                       Do I have to be employed to receive a policy
                                    </button>
                                </h5>
                            </div>
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                <div class="card-body">
                                    You definitely don't have to be employed to get services from us.
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-header" id="headingThree">
                                <h5 class="mb-0">
                                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        Can a policy cover my family members
                                    </button>
                                </h5>
                            </div>
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                <div class="card-body">
                                   Yes. It can cover upto ten members.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                                <div class="card-body">
                                    Our offices are located along Narok-Nakuru highway, Narok. You are welcome anytime during our opening hours.
                                </div>
                            </div>
                        </div>
                    </div>
