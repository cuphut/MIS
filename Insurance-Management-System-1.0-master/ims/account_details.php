 ...
 */
    ...
    class account_detailsPage extends Page
    {
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            // View column for co_name field
            //
            $column = new TextViewColumn('username', 'username', 'Userame', $this->dataset);
            $column->SetOrderable(true);
            $grid->AddSingleRecordViewColumn($column);
    ...
    try
    {
        $Page = new account_detailsPage("account_details", "account_details.php", GetCurrentUserPermissionSetForDataSource("account_details"), 'UTF-8');
        $Page->SetTitle('Account Details');
        $Page->SetMenuLabel('Account Details');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("account_details"));
