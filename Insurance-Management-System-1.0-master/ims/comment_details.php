 ...
 */
    ...
    class comment_detailsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->addFields(
                array(
                    new StringField('commentID', true),
                    new StringField('email', true),
                    new StringField('name', true),
                    new StringField('comment', true),
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'commentID', 'commentID', 'Comment ID'),
        ...
        {
            $main_editor = new TextEdit('commentID_edit');
            ...
            $main_editor = new TextEdit('comment_edit');
            $main_editor->SetMaxLength(20);
        ...
        {
            //
            // View column for commentID field
            //
            $column = new TextViewColumn('commentID', 'commentID', 'Comment ID', $this->dataset);
        ...
        {
            //
            // Edit column for commentID field
            //
            $editor = new TextEdit('commentID_edit');
            $editor->SetMaxLength(20);
            $editColumn = new CustomEditColumn('Comment ID', 'commentID', $editor, $this->dataset);
    ...
    try
    {
        $Page = new comment_detailsPage("comment_details", "comment_details.php", GetCurrentUserPermissionSetForDataSource("comment_details"), 'UTF-8');
        $Page->SetTitle('Comment Details');
        $Page->SetMenuLabel('Comment Details');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("comment_details"));
