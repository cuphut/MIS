            ...
            <div class="row">
                <div class="col-lg-8 posts-list">
                    <form action="companyreg.php" method="post">
                        ...
                        <div class="mt-10">
                            <input type="text" name="cocity" placeholder="Company City" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Company City'" required class="single-input">
                        </div>
                        ...
                        <div class="mt-10" align="center">
                            ...
                            <button style="margin-left: 50px" type="reset" name="submitreg" class="genric-btn danger-border"><a href="home.php">Cancel Update</a>
                            </button>
